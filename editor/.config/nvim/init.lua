...
vim.api.nvim_create_user_command('Cplug', function(opts)
  vim.cmd('edit ~/.config/nvim/lua/custom/plugins/' .. opts.args .. '.lua')
end, { nargs = 1 })
...
require('lazy').setup({
    ...
    config = function()
      ...
      local servers = {
        ...
        jdtls = {
          cmd = {
            'jdtls',
            '-javaagent:/home/suman/.local/share/nvim/lombok.jar',
            '-Xbootclasspath/a:/home/suman/.local/share/nvim/lombok.jar',
          },
        },
        lemminx = {},
      }
  ...
  { -- You can easily change to a different colorscheme.
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, 'DiagnosticVirtualTextHint', { fg = '#8ec07c' })
    end,
  },
  ...
  -- Highlight todo, notes, etc in comments
  {
    ...
    opts = {
      ...
      keywords = {
        ...
        TODO = { color = 'todo_color' },
      },

      colors = {
        note_color = { '#80D9CA' }, -- change to any color
        todo_color = { '#C9A87F' },
      },
    },
  },
  ...
  -- TypeScript language server (faster than ts_ls, connects directly to TypeScript)
  {
